...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Set Camera Zoom', "Dont confuse it with Add Camera Zoom.\nValue 1: Set Camera Zoom (defaultCamZoom)\nValue 2: how long it takes to zoom in (default uhh idk)"],
		...
		['Flash Camera', "yea\nValue 1: duration of how long the camera flashes"]
	];
